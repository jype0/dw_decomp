...
void spawnToyTownBoxes(void)
{
  ...
  int new_var3;
  int new_var7;
  bigLoc.vx = (new_var9 = BIG_BOX_LOCATION.vx);
  new_var7 = SMALL_BOX_LOCATION.pad == 0U;
 ...
 if (1) { } if (1) { } if (1) { } if (1) { }
  ...
  ;
  readFile(SMALL_BOX_TMD, ((char *) GENERAL_MESH_BUFFER) + 0x800);
  new_var6 = (char *) GENERAL_MESH_BUFFER;
  GsMapModelingData((u_long *) (new_var6 + 4));
  new_var8 = buf2 + 4;
  GsMapModelingData((u_long *) new_var8);
