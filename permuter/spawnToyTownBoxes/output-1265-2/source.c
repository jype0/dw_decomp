...
void spawnToyTownBoxes(void)
{
  ...
  for (i = 0; inline_fn(i) <= (2 - 1); i++)
  {
    ...
    GsLinkObject4((u_long) (buf2 + ((((((((0xC & 0xFFFFFFFF) & 0xFFFFFFFF) & 0xFFFFFFFF) & 0xFFFFFFFF) & 0xFFFFFFFF) & 0xFFFFFFFF) & 0xFFFFFFFF) & 0xFFFFFFFF)), &GENERAL_OBJECT[new_var4], new_var4);
  ...
  do
  {
    ...
    new_var3 = 0;
    GENERAL_COORDS[0].flg = (0, new_var3);
