...
void setMemoryCardReadError(int32_t id, int32_t slot);
int32_t MAIN_func_801125A8(int32_t unused, int32_t mode);
inline int inline_fn(int32_t arg0)
{
  return arg0 + 0x1FFF;
}
...
int32_t MAIN_func_80112628(int32_t channel, int32_t slot)
{
  ...
  int32_t i;
  int32_t ofs;
  struct DIRENTRY * volatile new_var;
  ...
  if (r == (-1))
  {
    ...
    if ((r == 3) || (0 == r))
  {
 goto dummy_label_138696; new_var = MAIN_D_801346D0; dummy_label_138696: ;
    total = 0;
    ofs = 0;
    for (i = 0; i < nfiles; i++)
    {
      total += inline_fn(*((int32_t *) ((((char *) new_var) + ofs) + 0x18))) / 0x2000;
      ofs += 0x28;
    }
