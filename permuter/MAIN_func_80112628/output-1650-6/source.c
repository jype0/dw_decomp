...
long MemCardExist();
long MemCardSync(volatile char mode, long *cmd, long *result);
...
void renderText(POLY_FT4 *prim, int32_t x, int32_t y, uint8_t u, int32_t v, int32_t w, int32_t h, int32_t textColor);
...
void *main_menu_order_anchor[] = {MAIN_func_80113A20, gameClearSave, awardMachinedramonData, MAIN_func_801138B0, openSaveMachine, createByteSum, MAIN_func_801136C8, registerBattleData, renderMainMenu, MAIN_func_8011341C, writeSavegame, loadSavegame, createSavegameChecksum, _strncpy, initializeDefaultSavegame, MAIN_func_8011296C, loadSaveSlotData, MAIN_func_80112628, MAIN_func_801125A8, setMemoryCardReadError, MAIN_func_80112524, MAIN_func_8011239C, tickMainMenu, updateMemoryCardState, MAIN_func_8010FC48, MAIN_func_8010FBB0, MAIN_func_8010FB7C, drawSaveSlotText, drawMainMenuStrings, MAIN_func_8010EA1C, MAIN_func_8010E938, MAIN_func_8010E8C0, MAIN_func_8010E73C, MAIN_func_8010E638, MAIN_func_8010E4B8, MAIN_func_8010E350, MAIN_func_8010E16C, MAIN_func_8010E0C8, MAIN_func_8010DFAC, MAIN_func_8010DEBC, renderContinueSaveSelection, MAIN_func_8010DA44, renderSaveSlotBox, MAIN_func_8010D70C, MAIN_func_8010D694, MAIN_func_8010D554, MAIN_func_8010D3E0, renderMenuBox, renderText, MAIN_func_8010D034};
void renderText(POLY_FT4 *prim, int32_t x, int32_t y, uint8_t u, int32_t v, int32_t w, int32_t h, int32_t textColor);
void renderMenuBox(int32_t x, int32_t y, int16_t w, int16_t h);
...
void setMemoryCardReadError(int32_t id, int32_t slot);
int32_t MAIN_func_801125A8(int32_t unused, int32_t mode);
inline int inline_fn(int32_t arg0, long arg1)
{
  return arg0 < arg1;
}
...
int32_t MAIN_func_80112628(int32_t channel, int32_t slot)
{
  ...
  int32_t ofs;
  new_var3 = 0;
  MemCardSync(new_var3, &cmd, &result);
  r = MemCardGetDirentry(channel, &(&MAIN_D_801346C0)[2], MAIN_D_801346D0, &nfiles, new_var3, 0xF);
  new_var2 = -1;
  new_var2 = (i = r) == new_var2;
  if (new_var2)
  {
    setMemoryCardReadError(new_var3, slot);
  }
  else
    if ((i == 3) || (i == new_var3))
  {
 total = new_var3; ofs = new_var3;
    new_var = ((*((int32_t *) ((((char *) MAIN_D_801346D0) + ofs) + 0x18))) + 0x1FFF) / 0x2000;
    for (i = new_var3; inline_fn(i, nfiles); i++)
    {
      total += new_var;
      ofs += 0x28;
    }
